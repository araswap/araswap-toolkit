...
export type AraswapToggleTheme = {
...
export interface AraswapToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  araswapSize: "araswapSize",
  travelDistance: "travelDistance",
  toggleHeight: "toggleHeight",
  toggleWidth: "toggleWidth",
  araswapThickness: "araswapThickness",
  araswapTwoOffset: "araswapTwoOffset",
  araswapThreeOffset: "araswapThreeOffset",
  butterTop: "butterTop",
